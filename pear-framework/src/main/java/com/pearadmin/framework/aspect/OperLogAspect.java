package com.pearadmin.framework.aspect;

import com.alibaba.fastjson.JSON;
import com.pearadmin.common.annotation.OperLog;
import com.pearadmin.common.enums.BusinessStatus;
...
public class OperLogAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(com.pearadmin.common.annotation.OperLog)")
    ...
    protected void handleLog(final JoinPoint joinPoint, final Exception e, Object jsonResult)
    {
        ...
        try {
            ...
            log.setStatus(BusinessStatus.SUCCESS.toString());
            // 请求地址
            ...
            if (e != null)
            {
                log.setStatus(BusinessStatus.FAIL.toString());
    ...
    {
        // 设置action动作
        operLog.setBusinessType(log.businessType().toString());
        // 设置标题
