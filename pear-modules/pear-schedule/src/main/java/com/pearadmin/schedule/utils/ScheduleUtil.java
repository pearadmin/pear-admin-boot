package com.pearadmin.schedule.utils;
...
public class ScheduleUtil {
    ...
    public static void createJob (Scheduler scheduler, ScheduleJobBean scheduleJob){
        try {
            // 构建定时器
            JobDetail jobDetail = JobBuilder.newJob(TaskJobLog.class).withIdentity(getJobKey(Long.parseLong(scheduleJob.getJobId()))).build() ;
